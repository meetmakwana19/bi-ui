...
const AddUserToneForm: React.FC = () => {
  return (
    <div className='user-tone-entry'>
      <ToneEntryHeader />
      <form action="submit">
        <div className="tone-field-div">
          <FieldLabel className='tone-content-padding' htmlFor="name">
            Title
          </FieldLabel>
          <TextInput version="v2" width="full" required={true} placeholder="Type something..." />
        </div>
        <div className="tone-field-div">
          <FieldLabel className='tone-content-padding' htmlFor="description">
            Edit User Tone
            <Help text="Below are the key insights Contentstack Intelligence has extracted about your Tone from the provided content" />
          </FieldLabel>
        ...
        <div className="tone-field-div">
          <FieldLabel className='tone-content-padding' htmlFor="name">
            Tags
            <Help text="Tags will help you find pertinent Knowledge Base entries more easily." />
          </FieldLabel>
